...
X_test['AGE']=X_test['AGE'].fillna(X_test['AGE'].mean,inplace=True)
X_test['CAR_AGE']=X_test['CAR_AGE'].fillna(X_test['CAR_AGE'].mean,inplace=True)
X_test['INCOME']=X_test['INCOME'].fillna(X_test['INCOME'].mean,inplace=True)
X_test['HOME_VAL']=X_test['HOME_VAL'].fillna(X_test['HOME_VAL'].mean,inplace=True)
# Code ends here
